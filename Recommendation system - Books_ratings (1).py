...
import pandas as pd
#import Dataset 
book = pd.read_csv("C:\\Users\\Nik\\Downloads\\book (1).csv",dtype=str,encoding='latin-1')
book.shape #shape
book.columns
book.Rating#ratings column
...
tfidf_matrix = tfidf.fit_transform(book.Rating)   #Transform a count matrix to a normalized tf or tf-idf representation
